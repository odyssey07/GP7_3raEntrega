...
//        
//        Alumno u = ad.buscarAlumno(7);
//        Materia m = md.buscarMateria(1);
//        
//        Inscripcion insc = new Inscripcion(u, m, 10);
        
//        id.guardarInscripcion(insc);
//        id.actualizarNota(7, 1, 1);
//        id.borrarInscripcion(7, 1);

//        System.out.println(id.obtenerInscripcionesPorAlumno(12));
          System.out.println(id.obtenerMateriasDeAlumno(7));
